...
alias ezmake='make clean && make ergodox_ez:pfn-dvorak && xmodmap ~/.Xmodmap'
...
alias pdf2tif='gs -dNOPAUSE -r300 -sDEVICE=tiffg4 -sOutputFile=vdmast.tif'
alias pgp='gpg'
...
alias startx-logged='startx > /home/niels/files/startx-$(date +%d%m%y-%H:%M).log'
...
alias tree='tree -C'
alias trtunnel='ssh -L 9091:localhost:9091 pfn'
alias v='vim'
