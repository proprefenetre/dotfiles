...
df_dir=$PWD
dest_home=(bashrc bash_aliases bash_profile vimrc gitconfig gtkrc-2.0 i3blocks.conf snippyrc tmux.conf xbindkeysrc xinitrc Xresources reminders urlview mutt)
