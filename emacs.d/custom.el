(custom-set-variables
 ...
 '(package-selected-packages
   '(org-ref nord-theme nordless-theme material-theme elpy emacs-lisp-mode general swiper hydra counsel ivy edit-indirect minions aggressive-indent color-theme-sanityinc-tomorrow company dash gruvbox-theme magit org-plus-contrib s solarized-theme toc-org which-key yasnippet paredit racket-mode yaml-mode guess-language python-mode rust-mode flycheck-rust flycheck smart-mode-line rainbow-delimiters base16-theme markdown-mode olivetti eyebrowse key-chord evil-commentary evil-surround evil-collection evil use-package)))
(custom-set-faces
