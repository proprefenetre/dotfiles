...
#+END_SRC
*** Company
Company provides all sorts of completion (Question: does it integrate with C-n/C-p?)
...
with richer versions. Also, I have no idea yet what projectile is. Apparently 
it's nice, but we'll see.
...
*** General
[[https://github.com/noctuid/general.el][General.el]] provides a convenient interface for binding keys
...
*** Key-chord
Key-chord enables you to define, exactly, key-chords. It integrates with general.el
and is indispensable for =jj=
...
#+END_SRC
*** Markdown-mode
Markdown-mode provides syntax-highligh- Font Locking for markdown files.
...
*** Olivetti
Olivetti provides a writeroom-like environment for 'distraction-free' writing. I've 
never been distraction-free, but I like the way it centers your text.
...
*** Which-key
When you pause halfway through a key combination, Which-key gives you a popup 
with all possible continuations. 
...
*** Yasnippet
Yasnippets provides snippets/templates, like Ultisnips for vim.
